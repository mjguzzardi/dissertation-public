...
reg_month_pta_check <- feols(log(n) ~ i(start_time_month, treat, ref='2019-05-01') | start_time_month + city_bike_city, vcov='hetero', data=pta_check_df)

#output reg table
etable(reg_month_pta_check)

#this plots the event study
#iplot(reg_month_pta_check)
